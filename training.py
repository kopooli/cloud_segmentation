...
train_dataset = CloudDatasetDoubleTiles(data_path, mask_path, train_scenes, "train", transform)
...
train_dataloader = DataLoader(
    train_dataset, batch_size=64, shuffle=True, num_workers=n_cpu-1
)
...
model = CloudSegmenter("Linknet", "timm-mobilenetv3_small_minimal_100", print_pictures=False)
